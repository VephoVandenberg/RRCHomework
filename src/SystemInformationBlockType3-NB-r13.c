...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_npbch_RRM_Config_r15_constr_43 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_npbch_RRM_Config_r15_value2enum_43[] = {
	{ 0,	7,	"enabled" }
};
static const unsigned int asn_MAP_npbch_RRM_Config_r15_enum2value_43[] = {
	0	/* enabled(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_npbch_RRM_Config_r15_specs_43 = {
	asn_MAP_npbch_RRM_Config_r15_value2enum_43,	/* "tag" => N; sorted by tag */
	asn_MAP_npbch_RRM_Config_r15_enum2value_43,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_npbch_RRM_Config_r15_tags_43[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_npbch_RRM_Config_r15_43 = {
	"npbch-RRM-Config-r15",
	"npbch-RRM-Config-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_npbch_RRM_Config_r15_tags_43,
	sizeof(asn_DEF_npbch_RRM_Config_r15_tags_43)
		/sizeof(asn_DEF_npbch_RRM_Config_r15_tags_43[0]) - 1, /* 1 */
	asn_DEF_npbch_RRM_Config_r15_tags_43,	/* Same as above */
	sizeof(asn_DEF_npbch_RRM_Config_r15_tags_43)
		/sizeof(asn_DEF_npbch_RRM_Config_r15_tags_43[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_npbch_RRM_Config_r15_constr_43,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_npbch_RRM_Config_r15_specs_43	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext5_41[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType3_NB_r13__ext5, nsss_RRM_Config_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3_NB_r13__ext5, npbch_RRM_Config_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_npbch_RRM_Config_r15_43,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext5_oms_41[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_ext5_tags_41[] = {
	(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext5_tag2el_41[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nsss-RRM-Config-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* npbch-RRM-Config-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_41 = {
	sizeof(struct SystemInformationBlockType3_NB_r13__ext5),
	offsetof(struct SystemInformationBlockType3_NB_r13__ext5, _asn_ctx),
	asn_MAP_ext5_tag2el_41,
	2,	/* Count of tags in the map */
	asn_MAP_ext5_oms_41,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext5_41 = {
	"ext5",
	"ext5",
	&asn_OP_SEQUENCE,
	asn_DEF_ext5_tags_41,
	sizeof(asn_DEF_ext5_tags_41)
		/sizeof(asn_DEF_ext5_tags_41[0]) - 1, /* 1 */
	asn_DEF_ext5_tags_41,	/* Same as above */
	sizeof(asn_DEF_ext5_tags_41)
		/sizeof(asn_DEF_ext5_tags_41[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext5_41,
	2,	/* Elements count */
	&asn_SPC_ext5_specs_41	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_NB_r13_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct SystemInformationBlockType3_NB_r13, freqBandInfo_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NS_PmaxList_NB_r13,
		0,
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType3_NB_r13, multiBandInfoList_r13),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct SystemInformationBlockType3_NB_r13, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType3_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_33,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType3_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext2_35,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType3_NB_r13, ext3),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext3_37,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType3_NB_r13, ext4),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext4_39,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType3_NB_r13, ext5),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext5_41,
		0,
...
static const int asn_MAP_SystemInformationBlockType3_NB_r13_oms_1[] = { 3, 4, 5, 6, 7, 8, 9, 10 };

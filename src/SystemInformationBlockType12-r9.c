...
static asn_TYPE_member_t asn_MBR_ext1_12[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType12_r9__ext1, warningAreaCoordinatesSegment_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_12[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* warningAreaCoordinatesSegment-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_12 = {
	sizeof(struct SystemInformationBlockType12_r9__ext1),
	offsetof(struct SystemInformationBlockType12_r9__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType12_r9_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType12_r9, ext1),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext1_12,
		0,

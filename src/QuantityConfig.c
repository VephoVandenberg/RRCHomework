...
static asn_TYPE_member_t asn_MBR_ext4_14[] = {
	{ ATF_POINTER, 1, offsetof(struct QuantityConfig__ext4, quantityConfigNRList_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_14 = {
	sizeof(struct QuantityConfig__ext4),
	offsetof(struct QuantityConfig__ext4, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_QuantityConfig_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct QuantityConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct QuantityConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_9,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct QuantityConfig, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct QuantityConfig, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_14,
		0,

...
typedef enum ReportConfigEUTRA__ext8__purpose_r15 {
	ReportConfigEUTRA__ext8__purpose_r15_sensing	= 0
} e_ReportConfigEUTRA__ext8__purpose_r15;
...
typedef struct ReportConfigEUTRA {
	...
	struct ReportConfigEUTRA__ext7 {
		long	*maxReportRS_Index_r15;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext7;
	struct ReportConfigEUTRA__ext8 {
...
extern asn_TYPE_member_t asn_MBR_ReportConfigEUTRA_1[14];

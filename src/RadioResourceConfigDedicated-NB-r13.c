...
static asn_TYPE_member_t asn_MBR_ext1_11[] = {
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicated_NB_r13__ext1, schedulingRequestConfig_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_11 = {
	sizeof(struct RadioResourceConfigDedicated_NB_r13__ext1),
	offsetof(struct RadioResourceConfigDedicated_NB_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicated_NB_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicated_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,

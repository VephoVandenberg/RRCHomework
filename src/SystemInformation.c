...
static asn_per_constraints_t asn_PER_type_criticalExtensionsFuture_r15_constr_4 CC_NOTUSED = {
...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_6 = {
	sizeof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15__criticalExtensionsFuture),
	offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_criticalExtensionsFuture_r15_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15, choice.posSystemInformation_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_criticalExtensionsFuture_r15_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* posSystemInformation-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture */
};
static asn_CHOICE_specifics_t asn_SPC_criticalExtensionsFuture_r15_specs_4 = {
	sizeof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15),
	offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15, _asn_ctx),
	offsetof(struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15, present),
	sizeof(((struct SystemInformation__criticalExtensions__criticalExtensionsFuture_r15 *)0)->present),
	asn_MAP_criticalExtensionsFuture_r15_tag2el_4,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_criticalExtensionsFuture_r15_4 = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_criticalExtensionsFuture_r15_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_criticalExtensionsFuture_r15_4,
	2,	/* Elements count */
	&asn_SPC_criticalExtensionsFuture_r15_specs_4	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SystemInformation__criticalExtensions, choice.criticalExtensionsFuture_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_criticalExtensionsFuture_r15_4,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,

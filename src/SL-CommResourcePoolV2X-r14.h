...
struct SL_CBR_PPPP_TxConfigList_v1530;
...
typedef struct SL_CommResourcePoolV2X_r14 {
	 ...
	 */
	struct SL_CommResourcePoolV2X_r14__ext1 {
		struct SL_MinT2ValueList_r15	*sl_MinT2ValueList_r15;	/* OPTIONAL */
		struct SL_CBR_PPPP_TxConfigList_v1530	*cbr_pssch_TxConfigList_v1530;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_SL_CommResourcePoolV2X_r14_1[17];

...
asn_TYPE_member_t asn_MBR_MeasResults_1[] = {
	...
	{ ATF_POINTER, 9, offsetof(struct MeasResults, measResultNeighCells),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	...
	{ ATF_POINTER, 8, offsetof(struct MeasResults, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
	...
	{ ATF_POINTER, 7, offsetof(struct MeasResults, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_16,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct MeasResults, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_19,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct MeasResults, ext4),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext4_23,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct MeasResults, ext5),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext5_31,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct MeasResults, ext6),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext6_33,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasResults, ext7),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext7_36,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResults, ext8),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext8_39,
		0,
...
static const int asn_MAP_MeasResults_oms_1[] = { 2, 3, 4, 5, 6, 7, 8, 9, 10 };

...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_edt_SmallTBS_Subset_r15_constr_79 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_edt_SmallTBS_Subset_r15_value2enum_79[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_edt_SmallTBS_Subset_r15_enum2value_79[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_edt_SmallTBS_Subset_r15_specs_79 = {
	asn_MAP_edt_SmallTBS_Subset_r15_value2enum_79,	/* "tag" => N; sorted by tag */
	asn_MAP_edt_SmallTBS_Subset_r15_enum2value_79,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_edt_SmallTBS_Subset_r15_tags_79[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_edt_SmallTBS_Subset_r15_79 = {
	"edt-SmallTBS-Subset-r15",
	"edt-SmallTBS-Subset-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_edt_SmallTBS_Subset_r15_tags_79,
	sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_79)
		/sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_79[0]) - 1, /* 1 */
	asn_DEF_edt_SmallTBS_Subset_r15_tags_79,	/* Same as above */
	sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_79)
		/sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_79[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_edt_SmallTBS_Subset_r15_constr_79,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_edt_SmallTBS_Subset_r15_specs_79	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext2_78[] = {
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon__ext2, edt_SmallTBS_Subset_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_edt_SmallTBS_Subset_r15_79,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext2_oms_78[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext2_tags_78[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_78[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* edt-SmallTBS-Subset-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_78 = {
	sizeof(struct RACH_ConfigCommon__ext2),
	offsetof(struct RACH_ConfigCommon__ext2, _asn_ctx),
	asn_MAP_ext2_tag2el_78,
	1,	/* Count of tags in the map */
	asn_MAP_ext2_oms_78,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext2_78 = {
	"ext2",
	"ext2",
	&asn_OP_SEQUENCE,
	asn_DEF_ext2_tags_78,
	sizeof(asn_DEF_ext2_tags_78)
		/sizeof(asn_DEF_ext2_tags_78[0]) - 1, /* 1 */
	asn_DEF_ext2_tags_78,	/* Same as above */
	sizeof(asn_DEF_ext2_tags_78)
		/sizeof(asn_DEF_ext2_tags_78[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext2_78,
	1,	/* Elements count */
	&asn_SPC_ext2_specs_78	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RACH_ConfigCommon, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_75,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_78,
		0,

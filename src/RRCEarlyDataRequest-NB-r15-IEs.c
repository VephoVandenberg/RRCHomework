...
static const asn_INTEGER_enum_map_t asn_MAP_establishmentCause_r15_value2enum_3[] = {
	{ 0,	11,	"mo-Data-r15" },
	{ 1,	20,	"mo-ExceptionData-r15" },
	{ 2,	23,	"delayTolerantAccess-r15" },
	{ 3,	6,	"spare1" }
};
static const unsigned int asn_MAP_establishmentCause_r15_enum2value_3[] = {
	2,	/* delayTolerantAccess-r15(2) */
	0,	/* mo-Data-r15(0) */
	1,	/* mo-ExceptionData-r15(1) */
	3	/* spare1(3) */
};
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_10 = {
	sizeof(struct RRCEarlyDataRequest_NB_r15_IEs__nonCriticalExtension),
	offsetof(struct RRCEarlyDataRequest_NB_r15_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_RRCEarlyDataRequest_NB_r15_IEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCEarlyDataRequest_NB_r15_IEs, s_TMSI_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCEarlyDataRequest_NB_r15_IEs, establishmentCause_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct RRCEarlyDataRequest_NB_r15_IEs, cqi_NPDCCH_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCEarlyDataRequest_NB_r15_IEs, dedicatedInfoNAS_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct RRCEarlyDataRequest_NB_r15_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
...
static const int asn_MAP_RRCEarlyDataRequest_NB_r15_IEs_oms_1[] = { 2, 4 };
static const ber_tlv_tag_t asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRCEarlyDataRequest_NB_r15_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_RRCEarlyDataRequest_NB_r15_IEs_specs_1 = {
	sizeof(struct RRCEarlyDataRequest_NB_r15_IEs),
	offsetof(struct RRCEarlyDataRequest_NB_r15_IEs, _asn_ctx),
	asn_MAP_RRCEarlyDataRequest_NB_r15_IEs_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_RRCEarlyDataRequest_NB_r15_IEs_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_RRCEarlyDataRequest_NB_r15_IEs = {
	"RRCEarlyDataRequest-NB-r15-IEs",
	"RRCEarlyDataRequest-NB-r15-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1,
	sizeof(asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1)
		/sizeof(asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1[0]), /* 1 */
	asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1)
		/sizeof(asn_DEF_RRCEarlyDataRequest_NB_r15_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_RRCEarlyDataRequest_NB_r15_IEs_1,
	5,	/* Elements count */
	&asn_SPC_RRCEarlyDataRequest_NB_r15_IEs_specs_1	/* Additional specs */
};

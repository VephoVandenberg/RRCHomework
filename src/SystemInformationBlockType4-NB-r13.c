...
static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType4_NB_r13__ext1, nsss_RRM_Config_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType4_NB_r13__ext1, intraFreqNeighCellList_v1530),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct SystemInformationBlockType4_NB_r13__ext1),
	offsetof(struct SystemInformationBlockType4_NB_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType4_NB_r13_1[] = {
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType4_NB_r13, intraFreqNeighCellList_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType4_NB_r13, intraFreqBlackCellList_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType4_NB_r13, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType4_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
...
static const int asn_MAP_SystemInformationBlockType4_NB_r13_oms_1[] = { 0, 1, 2, 3 };

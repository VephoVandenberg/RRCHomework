...
static asn_TYPE_member_t asn_MBR_ext2_9[] = {
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon_NB_r13__ext2, rach_InfoList_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* rach-InfoList-v1530 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_9 = {
	sizeof(struct RACH_ConfigCommon_NB_r13__ext2),
	offsetof(struct RACH_ConfigCommon_NB_r13__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_NB_r13_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_connEstFailOffset_r13_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_connEstFailOffset_r13_constraint_1
		},
		0, 0, /* No default value */
		"connEstFailOffset-r13"
		},
	{ ATF_POINTER, 2, offsetof(struct RACH_ConfigCommon_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_9,
		0,

...
typedef enum CellsTriggeredList__Member_PR {
	...
	CellsTriggeredList__Member_PR_physCellIdNR_r15
...
typedef struct CellsTriggeredList__Member {
	...
	union CellsTriggeredList__Member_u {
		...
		struct CellsTriggeredList__Member__physCellIdNR_r15 {
			ARFCN_ValueNR_r15_t	 carrierFreq;
			PhysCellIdNR_r15_t	 physCellId;
			struct SSB_IndexList_r15	*rs_IndexList_r15;	/* OPTIONAL */

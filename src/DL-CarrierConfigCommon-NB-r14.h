...
typedef struct DL_CarrierConfigCommon_NB_r14 {
	 ...
	 */
	struct DL_CarrierConfigCommon_NB_r14__ext1 {
		struct DL_GapConfig_NB_v1530	*dl_GapNonAnchor_v1530;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext1;
	struct DL_CarrierConfigCommon_NB_r14__ext2 {
...
extern asn_TYPE_member_t asn_MBR_DL_CarrierConfigCommon_NB_r14_1[7];

...
static asn_TYPE_member_t asn_MBR_ext2_70[] = {
	{ ATF_POINTER, 1, offsetof(struct RRM_Config__ext2, candidateCellInfoListNR_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		...
		0, 0, /* No default value */
		"candidateCellInfoListNR-r15"
		},
};
static const int asn_MAP_ext2_oms_70[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext2_tags_70[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext2_tag2el_70[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* candidateCellInfoListNR-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_70 = {
	sizeof(struct RRM_Config__ext2),
	offsetof(struct RRM_Config__ext2, _asn_ctx),
	asn_MAP_ext2_tag2el_70,
	1,	/* Count of tags in the map */
	asn_MAP_ext2_oms_70,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext2_70 = {
	"ext2",
	"ext2",
	&asn_OP_SEQUENCE,
	asn_DEF_ext2_tags_70,
	sizeof(asn_DEF_ext2_tags_70)
		/sizeof(asn_DEF_ext2_tags_70[0]) - 1, /* 1 */
	asn_DEF_ext2_tags_70,	/* Same as above */
	sizeof(asn_DEF_ext2_tags_70)
		/sizeof(asn_DEF_ext2_tags_70[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext2_70,
	1,	/* Elements count */
	&asn_SPC_ext2_specs_70	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RRM_Config_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RRM_Config, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_68,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RRM_Config, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_70,
		0,

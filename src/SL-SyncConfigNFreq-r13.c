...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_slss_TxDisabled_r15_constr_25 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_gnss_Sync_r14_constr_19,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
...
static const asn_INTEGER_enum_map_t asn_MAP_slss_TxDisabled_r15_value2enum_25[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_slss_TxDisabled_r15_enum2value_25[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_slss_TxDisabled_r15_specs_25 = {
	asn_MAP_slss_TxDisabled_r15_value2enum_25,	/* "tag" => N; sorted by tag */
	asn_MAP_slss_TxDisabled_r15_enum2value_25,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_slss_TxDisabled_r15_tags_25[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_slss_TxDisabled_r15_25 = {
	"slss-TxDisabled-r15",
	"slss-TxDisabled-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_slss_TxDisabled_r15_tags_25,
	sizeof(asn_DEF_slss_TxDisabled_r15_tags_25)
		/sizeof(asn_DEF_slss_TxDisabled_r15_tags_25[0]) - 1, /* 1 */
	asn_DEF_slss_TxDisabled_r15_tags_25,	/* Same as above */
	sizeof(asn_DEF_slss_TxDisabled_r15_tags_25)
		/sizeof(asn_DEF_slss_TxDisabled_r15_tags_25[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_slss_TxDisabled_r15_constr_25,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_slss_TxDisabled_r15_specs_25	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext3_24[] = {
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfigNFreq_r13__ext3, slss_TxDisabled_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_slss_TxDisabled_r15_25,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext3_oms_24[] = { 0 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_24 = {
	sizeof(struct SL_SyncConfigNFreq_r13__ext3),
	offsetof(struct SL_SyncConfigNFreq_r13__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SL_SyncConfigNFreq_r13_1[] = {
	{ ATF_POINTER, 6, offsetof(struct SL_SyncConfigNFreq_r13, asyncParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct SL_SyncConfigNFreq_r13, txParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct SL_SyncConfigNFreq_r13, rxParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct SL_SyncConfigNFreq_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct SL_SyncConfigNFreq_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_21,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SL_SyncConfigNFreq_r13, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_24,
		0,
...
static const int asn_MAP_SL_SyncConfigNFreq_r13_oms_1[] = { 0, 1, 2, 3, 4, 5 };

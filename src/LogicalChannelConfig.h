...
typedef enum LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_PR {
	LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_PR_NOTHING,	/* No components present */
	LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_PR_release,
	LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_PR_setup
} LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_PR;
typedef enum LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_PR {
	LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_PR_NOTHING,	/* No components present */
	LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_PR_release,
	LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_PR_setup
} LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_PR;
typedef enum LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15__setup {
	LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15__setup_spucch	= 0,
	LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15__setup_pucch	= 1
} e_LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15__setup;
typedef enum LogicalChannelConfig__ext4__channellAccessPriority_r15_PR {
	LogicalChannelConfig__ext4__channellAccessPriority_r15_PR_NOTHING,	/* No components present */
	LogicalChannelConfig__ext4__channellAccessPriority_r15_PR_release,
	LogicalChannelConfig__ext4__channellAccessPriority_r15_PR_setup
} LogicalChannelConfig__ext4__channellAccessPriority_r15_PR;
...
typedef struct LogicalChannelConfig {
	...
	struct LogicalChannelConfig__ext4 {
		struct LogicalChannelConfig__ext4__allowedTTI_Lengths_r15 {
			LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_PR present;
			union LogicalChannelConfig__ext4__allowedTTI_Lengths_r15_u {
				NULL_t	 release;
				struct LogicalChannelConfig__ext4__allowedTTI_Lengths_r15__setup {
		...
		struct LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15 {
			LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_PR present;
			union LogicalChannelConfig__ext4__logicalChannelSR_Restriction_r15_u {
				NULL_t	 release;
				long	 setup;
			} choice;
		...
		struct LogicalChannelConfig__ext4__channellAccessPriority_r15 {
			LogicalChannelConfig__ext4__channellAccessPriority_r15_PR present;
			union LogicalChannelConfig__ext4__channellAccessPriority_r15_u {
				NULL_t	 release;
				long	 setup;
			} choice;

 ...
 */
static int
memb_logicalChannelIdentity_r15_constraint_32(const asn_TYPE_descriptor_t *td, const void *sptr,
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_logicalChannelIdentity_r15_constr_35 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_ext4_30[] = {
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod__ext4, rlc_Config_v1510),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext4_oms_30[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext4_tags_30[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext4_tag2el_30[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* rlc-Config-v1510 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_30 = {
	sizeof(struct DRB_ToAddMod__ext4),
	offsetof(struct DRB_ToAddMod__ext4, _asn_ctx),
	asn_MAP_ext4_tag2el_30,
	1,	/* Count of tags in the map */
	asn_MAP_ext4_oms_30,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext4_30 = {
	"ext4",
	"ext4",
	&asn_OP_SEQUENCE,
	asn_DEF_ext4_tags_30,
	sizeof(asn_DEF_ext4_tags_30)
		/sizeof(asn_DEF_ext4_tags_30[0]) - 1, /* 1 */
	asn_DEF_ext4_tags_30,	/* Same as above */
	sizeof(asn_DEF_ext4_tags_30)
		/sizeof(asn_DEF_ext4_tags_30[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext4_30,
	1,	/* Elements count */
	&asn_SPC_ext4_specs_30	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext5_32[] = {
	{ ATF_POINTER, 3, offsetof(struct DRB_ToAddMod__ext5, rlc_Config_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct DRB_ToAddMod__ext5, rlc_BearerConfigSecondary_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod__ext5, logicalChannelIdentity_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_logicalChannelIdentity_r15_constr_35,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_logicalChannelIdentity_r15_constraint_32
		},
		0, 0, /* No default value */
		"logicalChannelIdentity-r15"
		},
};
static const int asn_MAP_ext5_oms_32[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_ext5_tags_32[] = {
	(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext5_tag2el_32[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_32 = {
	sizeof(struct DRB_ToAddMod__ext5),
	offsetof(struct DRB_ToAddMod__ext5, _asn_ctx),
	asn_MAP_ext5_tag2el_32,
	3,	/* Count of tags in the map */
	asn_MAP_ext5_oms_32,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext5_32 = {
	"ext5",
	"ext5",
	&asn_OP_SEQUENCE,
	asn_DEF_ext5_tags_32,
	sizeof(asn_DEF_ext5_tags_32)
		/sizeof(asn_DEF_ext5_tags_32[0]) - 1, /* 1 */
	asn_DEF_ext5_tags_32,	/* Same as above */
	sizeof(asn_DEF_ext5_tags_32)
		/sizeof(asn_DEF_ext5_tags_32[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext5_32,
	3,	/* Elements count */
	&asn_SPC_ext5_specs_32	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_DRB_ToAddMod_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct DRB_ToAddMod, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct DRB_ToAddMod, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct DRB_ToAddMod, ext3),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext3_21,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct DRB_ToAddMod, ext4),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext4_30,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod, ext5),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext5_32,
		0,

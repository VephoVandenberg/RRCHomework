...
typedef enum SystemInformationBlockType3_NB_r13__ext5__npbch_RRM_Config_r15 {
	SystemInformationBlockType3_NB_r13__ext5__npbch_RRM_Config_r15_enabled	= 0
} e_SystemInformationBlockType3_NB_r13__ext5__npbch_RRM_Config_r15;
...
typedef struct SystemInformationBlockType3_NB_r13 {
	...
	struct SystemInformationBlockType3_NB_r13__ext5 {
		struct NSSS_RRM_Config_NB_r15	*nsss_RRM_Config_r15;	/* OPTIONAL */
		long	*npbch_RRM_Config_r15;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_npbch_RRM_Config_r15_43;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType3_NB_r13_1[11];

...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_anyCellSelectionDetected_r15_constr_30 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_ext5_26[] = {
	{ ATF_POINTER, 2, offsetof(struct LogMeasInfo_r10__ext5, logMeasResultListBT_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct LogMeasInfo_r10__ext5, logMeasResultListWLAN_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext5_oms_26[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_ext5_tags_26[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext5_tag2el_26[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* logMeasResultListBT-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* logMeasResultListWLAN-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_26 = {
	sizeof(struct LogMeasInfo_r10__ext5),
	offsetof(struct LogMeasInfo_r10__ext5, _asn_ctx),
	asn_MAP_ext5_tag2el_26,
	2,	/* Count of tags in the map */
	asn_MAP_ext5_oms_26,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext5_26 = {
	"ext5",
	"ext5",
	&asn_OP_SEQUENCE,
	asn_DEF_ext5_tags_26,
	sizeof(asn_DEF_ext5_tags_26)
		/sizeof(asn_DEF_ext5_tags_26[0]) - 1, /* 1 */
	asn_DEF_ext5_tags_26,	/* Same as above */
	sizeof(asn_DEF_ext5_tags_26)
		/sizeof(asn_DEF_ext5_tags_26[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext5_26,
	2,	/* Elements count */
	&asn_SPC_ext5_specs_26	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_anyCellSelectionDetected_r15_value2enum_30[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_anyCellSelectionDetected_r15_enum2value_30[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_anyCellSelectionDetected_r15_specs_30 = {
	asn_MAP_anyCellSelectionDetected_r15_value2enum_30,	/* "tag" => N; sorted by tag */
	asn_MAP_anyCellSelectionDetected_r15_enum2value_30,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_anyCellSelectionDetected_r15_tags_30[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_anyCellSelectionDetected_r15_30 = {
	"anyCellSelectionDetected-r15",
	"anyCellSelectionDetected-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_anyCellSelectionDetected_r15_tags_30,
	sizeof(asn_DEF_anyCellSelectionDetected_r15_tags_30)
		/sizeof(asn_DEF_anyCellSelectionDetected_r15_tags_30[0]) - 1, /* 1 */
	asn_DEF_anyCellSelectionDetected_r15_tags_30,	/* Same as above */
	sizeof(asn_DEF_anyCellSelectionDetected_r15_tags_30)
		/sizeof(asn_DEF_anyCellSelectionDetected_r15_tags_30[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_anyCellSelectionDetected_r15_constr_30,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_anyCellSelectionDetected_r15_specs_30	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext6_29[] = {
	{ ATF_POINTER, 1, offsetof(struct LogMeasInfo_r10__ext6, anyCellSelectionDetected_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_anyCellSelectionDetected_r15_30,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext6_oms_29[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext6_tags_29[] = {
	(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext6_tag2el_29[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* anyCellSelectionDetected-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext6_specs_29 = {
	sizeof(struct LogMeasInfo_r10__ext6),
	offsetof(struct LogMeasInfo_r10__ext6, _asn_ctx),
	asn_MAP_ext6_tag2el_29,
	1,	/* Count of tags in the map */
	asn_MAP_ext6_oms_29,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext6_29 = {
	"ext6",
	"ext6",
	&asn_OP_SEQUENCE,
	asn_DEF_ext6_tags_29,
	sizeof(asn_DEF_ext6_tags_29)
		/sizeof(asn_DEF_ext6_tags_29[0]) - 1, /* 1 */
	asn_DEF_ext6_tags_29,	/* Same as above */
	sizeof(asn_DEF_ext6_tags_29)
		/sizeof(asn_DEF_ext6_tags_29[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext6_29,
	1,	/* Elements count */
	&asn_SPC_ext6_specs_29	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_LogMeasInfo_r10_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct LogMeasInfo_r10, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct LogMeasInfo_r10, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_16,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct LogMeasInfo_r10, ext3),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext3_21,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct LogMeasInfo_r10, ext4),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext4_24,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LogMeasInfo_r10, ext5),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext5_26,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LogMeasInfo_r10, ext6),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext6_29,
		0,

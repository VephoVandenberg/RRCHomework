...
static asn_TYPE_member_t asn_MBR_ext1_6[] = {
	{ ATF_POINTER, 4, offsetof(struct SL_V2X_Preconfiguration_r14__ext1, v2x_PacketDuplicationConfig_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct SL_V2X_Preconfiguration_r14__ext1, syncFreqList_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct SL_V2X_Preconfiguration_r14__ext1, slss_TxMultiFreq_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_Preconfiguration_r14__ext1, v2x_TxProfileList_r15),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_6 = {
	sizeof(struct SL_V2X_Preconfiguration_r14__ext1),
	offsetof(struct SL_V2X_Preconfiguration_r14__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_SL_V2X_Preconfiguration_r14_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SL_V2X_Preconfiguration_r14, anchorCarrierFreqList_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SL_V2X_Preconfiguration_r14, cbr_PreconfigList_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_Preconfiguration_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
...
static const int asn_MAP_SL_V2X_Preconfiguration_r14_oms_1[] = { 1, 2, 3 };

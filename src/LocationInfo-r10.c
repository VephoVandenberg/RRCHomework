...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_verticalVelocityInfo_r15_constr_15 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_verticalVelocityInfo_r15_15[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LocationInfo_r10__ext1__verticalVelocityInfo_r15, choice.verticalVelocity_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LocationInfo_r10__ext1__verticalVelocityInfo_r15, choice.verticalVelocityAndUncertainty_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_verticalVelocityInfo_r15_tag2el_15[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* verticalVelocity-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* verticalVelocityAndUncertainty-r15 */
};
static asn_CHOICE_specifics_t asn_SPC_verticalVelocityInfo_r15_specs_15 = {
	sizeof(struct LocationInfo_r10__ext1__verticalVelocityInfo_r15),
	offsetof(struct LocationInfo_r10__ext1__verticalVelocityInfo_r15, _asn_ctx),
	offsetof(struct LocationInfo_r10__ext1__verticalVelocityInfo_r15, present),
	sizeof(((struct LocationInfo_r10__ext1__verticalVelocityInfo_r15 *)0)->present),
	asn_MAP_verticalVelocityInfo_r15_tag2el_15,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_verticalVelocityInfo_r15_15 = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_verticalVelocityInfo_r15_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_verticalVelocityInfo_r15_15,
	2,	/* Elements count */
	&asn_SPC_verticalVelocityInfo_r15_specs_15	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct LocationInfo_r10__ext1, verticalVelocityInfo_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_verticalVelocityInfo_r15_15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_14 = {
	sizeof(struct LocationInfo_r10__ext1),
	offsetof(struct LocationInfo_r10__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LocationInfo_r10_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct LocationInfo_r10, horizontalVelocity_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LocationInfo_r10, gnss_TOD_msec_r10),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LocationInfo_r10, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
...
static const int asn_MAP_LocationInfo_r10_oms_1[] = { 1, 2, 3 };

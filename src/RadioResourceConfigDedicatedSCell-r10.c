...
static asn_TYPE_member_t asn_MBR_ext5_12[] = {
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedSCell_r10__ext5, crs_IntfMitigEnabled_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedSCell_r10__ext5, neighCellsCRS_Info_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10__ext5, sps_Config_v1530),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_12 = {
	sizeof(struct RadioResourceConfigDedicatedSCell_r10__ext5),
	offsetof(struct RadioResourceConfigDedicatedSCell_r10__ext5, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicatedSCell_r10_1[] = {
	{ ATF_POINTER, 6, offsetof(struct RadioResourceConfigDedicatedSCell_r10, physicalConfigDedicatedSCell_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_6,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext3),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext3_8,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext4),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext4_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10, ext5),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext5_12,
		0,
...
static const int asn_MAP_RadioResourceConfigDedicatedSCell_r10_oms_1[] = { 0, 1, 2, 3, 4, 5 };

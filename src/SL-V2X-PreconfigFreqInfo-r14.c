...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_syncPriority_r14_constr_9,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
static asn_TYPE_member_t asn_MBR_ext1_15[] = {
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_PreconfigFreqInfo_r14__ext1, v2x_FreqSelectionConfigList_r15),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_15 = {
	sizeof(struct SL_V2X_PreconfigFreqInfo_r14__ext1),
	offsetof(struct SL_V2X_PreconfigFreqInfo_r14__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SL_V2X_PreconfigFreqInfo_r14_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct SL_V2X_PreconfigFreqInfo_r14, thresSL_TxPrioritization_r14),
	...
	{ ATF_POINTER, 2, offsetof(struct SL_V2X_PreconfigFreqInfo_r14, offsetDFN_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_PreconfigFreqInfo_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext1_15,
		0,
...
static const int asn_MAP_SL_V2X_PreconfigFreqInfo_r14_oms_1[] = { 1, 5, 6, 8, 9, 10 };

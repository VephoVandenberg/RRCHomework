...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_ab_PerNRSRP_r15_constr_9 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_ab_PerNRSRP_r15_value2enum_9[] = {
	{ 0,	7,	"thresh1" },
	{ 1,	7,	"thresh2" }
};
static const unsigned int asn_MAP_ab_PerNRSRP_r15_enum2value_9[] = {
	0,	/* thresh1(0) */
	1	/* thresh2(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_ab_PerNRSRP_r15_specs_9 = {
	asn_MAP_ab_PerNRSRP_r15_value2enum_9,	/* "tag" => N; sorted by tag */
	asn_MAP_ab_PerNRSRP_r15_enum2value_9,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_ab_PerNRSRP_r15_tags_9[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ab_PerNRSRP_r15_9 = {
	"ab-PerNRSRP-r15",
	"ab-PerNRSRP-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_ab_PerNRSRP_r15_tags_9,
	sizeof(asn_DEF_ab_PerNRSRP_r15_tags_9)
		/sizeof(asn_DEF_ab_PerNRSRP_r15_tags_9[0]) - 1, /* 1 */
	asn_DEF_ab_PerNRSRP_r15_tags_9,	/* Same as above */
	sizeof(asn_DEF_ab_PerNRSRP_r15_tags_9)
		/sizeof(asn_DEF_ab_PerNRSRP_r15_tags_9[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ab_PerNRSRP_r15_constr_9,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ab_PerNRSRP_r15_specs_9	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_8[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType14_NB_r13__ext1, ab_PerNRSRP_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ab_PerNRSRP_r15_9,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_8[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ab-PerNRSRP-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_8 = {
	sizeof(struct SystemInformationBlockType14_NB_r13__ext1),
	offsetof(struct SystemInformationBlockType14_NB_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType14_NB_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType14_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,

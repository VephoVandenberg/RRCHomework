...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_additionalTxSIB1_Config_v1540_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_twoHARQ_ProcessesConfig_r14_constr_8,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_interferenceRandomisationConfig_r14_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_ext3_13[] = {
	{ ATF_POINTER, 1, offsetof(struct PhysicalConfigDedicated_NB_r13__ext3, npdcch_ConfigDedicated_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_ext3_tag2el_13[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* npdcch-ConfigDedicated-v1530 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_13 = {
	sizeof(struct PhysicalConfigDedicated_NB_r13__ext3),
	offsetof(struct PhysicalConfigDedicated_NB_r13__ext3, _asn_ctx),
...
static const asn_INTEGER_enum_map_t asn_MAP_additionalTxSIB1_Config_v1540_value2enum_16[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_additionalTxSIB1_Config_v1540_enum2value_16[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_additionalTxSIB1_Config_v1540_specs_16 = {
	asn_MAP_additionalTxSIB1_Config_v1540_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_additionalTxSIB1_Config_v1540_enum2value_16,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_additionalTxSIB1_Config_v1540_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_additionalTxSIB1_Config_v1540_16 = {
	"additionalTxSIB1-Config-v1540",
	"additionalTxSIB1-Config-v1540",
	&asn_OP_NativeEnumerated,
	asn_DEF_additionalTxSIB1_Config_v1540_tags_16,
	sizeof(asn_DEF_additionalTxSIB1_Config_v1540_tags_16)
		/sizeof(asn_DEF_additionalTxSIB1_Config_v1540_tags_16[0]) - 1, /* 1 */
	asn_DEF_additionalTxSIB1_Config_v1540_tags_16,	/* Same as above */
	sizeof(asn_DEF_additionalTxSIB1_Config_v1540_tags_16)
		/sizeof(asn_DEF_additionalTxSIB1_Config_v1540_tags_16[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_additionalTxSIB1_Config_v1540_constr_16,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_additionalTxSIB1_Config_v1540_specs_16	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext4_15[] = {
	{ ATF_POINTER, 1, offsetof(struct PhysicalConfigDedicated_NB_r13__ext4, additionalTxSIB1_Config_v1540),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_additionalTxSIB1_Config_v1540_16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_ext4_tag2el_15[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* additionalTxSIB1-Config-v1540 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_15 = {
	sizeof(struct PhysicalConfigDedicated_NB_r13__ext4),
	offsetof(struct PhysicalConfigDedicated_NB_r13__ext4, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PhysicalConfigDedicated_NB_r13_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct PhysicalConfigDedicated_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct PhysicalConfigDedicated_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_10,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PhysicalConfigDedicated_NB_r13, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PhysicalConfigDedicated_NB_r13, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_15,
		0,

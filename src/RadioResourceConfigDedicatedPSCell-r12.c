...
static asn_TYPE_member_t asn_MBR_ext3_10[] = {
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedPSCell_r12__ext3, sps_Config_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedPSCell_r12__ext3, crs_IntfMitigEnabled_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedPSCell_r12__ext3, neighCellsCRS_Info_r15),
...
static const int asn_MAP_ext3_oms_10[] = { 0, 1, 2 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_10 = {
	sizeof(struct RadioResourceConfigDedicatedPSCell_r12__ext3),
	offsetof(struct RadioResourceConfigDedicatedPSCell_r12__ext3, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext4_14[] = {
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedPSCell_r12__ext4, sps_Config_v1540),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_ext4_oms_14[] = { 0 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_14 = {
	sizeof(struct RadioResourceConfigDedicatedPSCell_r12__ext4),
	offsetof(struct RadioResourceConfigDedicatedPSCell_r12__ext4, _asn_ctx),
	asn_MAP_ext4_tag2el_14,
	1,	/* Count of tags in the map */
...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicatedPSCell_r12_1[] = {
	{ ATF_POINTER, 7, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, physicalConfigDedicatedPSCell_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, sps_Config_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SPS_Config,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, naics_Info_r12),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_8,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext3_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedPSCell_r12, ext4),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext4_14,
		0,
...
static const int asn_MAP_RadioResourceConfigDedicatedPSCell_r12_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };

...
typedef struct InterFreqCarrierFreqInfo_NB_r13 {
	...
	struct InterFreqCarrierFreqInfo_NB_r13__ext3 {
	...
	struct InterFreqCarrierFreqInfo_NB_r13__ext4 {
...
extern asn_TYPE_member_t asn_MBR_InterFreqCarrierFreqInfo_NB_r13_1[12];

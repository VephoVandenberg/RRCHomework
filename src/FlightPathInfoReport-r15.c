...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_4 = {
	sizeof(struct FlightPathInfoReport_r15__nonCriticalExtension),
	offsetof(struct FlightPathInfoReport_r15__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_FlightPathInfoReport_r15_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct FlightPathInfoReport_r15, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,

...
typedef struct DL_CarrierConfigDedicated_NB_r13 {
	...
	struct DL_CarrierConfigDedicated_NB_r13__ext2 {
		struct DL_GapConfig_NB_v1530	*dl_GapNonAnchor_v1530;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext2;
	struct DL_CarrierConfigDedicated_NB_r13__ext3 {
...
extern asn_TYPE_member_t asn_MBR_DL_CarrierConfigDedicated_NB_r13_1[7];

...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct UL_ConfigCommon_NB_r14__ext1, nprach_ParametersListEDT_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* nprach-ParametersListEDT-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct UL_ConfigCommon_NB_r14__ext1),
	offsetof(struct UL_ConfigCommon_NB_r14__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_UL_ConfigCommon_NB_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UL_ConfigCommon_NB_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,

...
static asn_TYPE_member_t asn_MBR_ext4_15[] = {
	{ ATF_POINTER, 1, offsetof(struct PSCellToAddMod_r12__ext4, radioResourceConfigDedicatedPSCell_v13c0),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const asn_TYPE_tag2member_t asn_MAP_ext4_tag2el_15[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* radioResourceConfigDedicatedPSCell-v13c0 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_15 = {
	sizeof(struct PSCellToAddMod_r12__ext4),
	offsetof(struct PSCellToAddMod_r12__ext4, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PSCellToAddMod_r12_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct PSCellToAddMod_r12, cellIdentification_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct PSCellToAddMod_r12, radioResourceConfigCommonPSCell_r12),
	...
	{ ATF_POINTER, 5, offsetof(struct PSCellToAddMod_r12, radioResourceConfigDedicatedPSCell_r12),
	...
	{ ATF_POINTER, 4, offsetof(struct PSCellToAddMod_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct PSCellToAddMod_r12, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PSCellToAddMod_r12, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PSCellToAddMod_r12, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_15,
		0,
...
static const int asn_MAP_PSCellToAddMod_r12_oms_1[] = { 1, 2, 3, 4, 5, 6, 7 };

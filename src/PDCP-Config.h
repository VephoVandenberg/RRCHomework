...
typedef enum PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15 {
	PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_kbyte2	= 0,
	PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_kbyte4	= 1,
	PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_kbyte8	= 2,
	PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_spare1	= 3
} e_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15;
typedef enum PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15 {
	PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15_sip_SDP	= 0,
	PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15_operator	= 1
} e_PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15;
typedef enum PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR {
	PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR_NOTHING,	/* No components present */
	PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR_release,
	PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR_setup
} PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR;
typedef enum PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15 {
	PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15_configured	= 0,
	PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15_activated	= 1
} e_PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15;
...
typedef struct PDCP_Config {
	...
	struct PDCP_Config__ext6 {
		struct PDCP_Config__ext6__uplinkDataCompression_r15 {
			long	 bufferSize_r15;
		...
		struct PDCP_Config__ext6__pdcp_DuplicationConfig_r15 {
			PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR present;
			union PDCP_Config__ext6__pdcp_DuplicationConfig_r15_u {
				NULL_t	 release;
				struct PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup {
...
extern asn_TYPE_member_t asn_MBR_PDCP_Config_1[10];

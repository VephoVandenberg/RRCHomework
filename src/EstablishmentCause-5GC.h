...
jer_type_encoder_f EstablishmentCause_5GC_encode_jer;
per_type_decoder_f EstablishmentCause_5GC_decode_uper;
per_type_encoder_f EstablishmentCause_5GC_encode_uper;
per_type_decoder_f EstablishmentCause_5GC_decode_aper;
per_type_encoder_f EstablishmentCause_5GC_encode_aper;

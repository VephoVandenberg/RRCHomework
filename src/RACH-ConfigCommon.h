...
typedef enum RACH_ConfigCommon__ext2__edt_SmallTBS_Subset_r15 {
	RACH_ConfigCommon__ext2__edt_SmallTBS_Subset_r15_true	= 0
} e_RACH_ConfigCommon__ext2__edt_SmallTBS_Subset_r15;
...
typedef struct RACH_ConfigCommon {
	...
	struct RACH_ConfigCommon__ext2 {

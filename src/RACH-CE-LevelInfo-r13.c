 ...
 */
static int
memb_edt_LastPreamble_r15_constraint_28(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_edt_TBS_r15_constr_31 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_mac_ContentionResolutionTimer_r15_constr_40 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_edt_LastPreamble_r15_constr_29 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_edt_TBS_r15_value2enum_31[] = {
	{ 0,	4,	"b328" },
	{ 1,	4,	"b408" },
	{ 2,	4,	"b504" },
	{ 3,	4,	"b600" },
...
static const unsigned int asn_MAP_edt_TBS_r15_enum2value_31[] = {
	7,	/* b1000or456(7) */
	0,	/* b328(0) */
	1,	/* b408(1) */
	2,	/* b504(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_edt_TBS_r15_specs_31 = {
	asn_MAP_edt_TBS_r15_value2enum_31,	/* "tag" => N; sorted by tag */
	asn_MAP_edt_TBS_r15_enum2value_31,	/* N => "tag"; sorted by N */
	8,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_edt_TBS_r15_tags_31[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_edt_TBS_r15_31 = {
	"edt-TBS-r15",
	"edt-TBS-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_edt_TBS_r15_tags_31,
	sizeof(asn_DEF_edt_TBS_r15_tags_31)
		/sizeof(asn_DEF_edt_TBS_r15_tags_31[0]) - 1, /* 1 */
	asn_DEF_edt_TBS_r15_tags_31,	/* Same as above */
	sizeof(asn_DEF_edt_TBS_r15_tags_31)
		/sizeof(asn_DEF_edt_TBS_r15_tags_31[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_edt_TBS_r15_constr_31,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_edt_TBS_r15_specs_31	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_mac_ContentionResolutionTimer_r15_value2enum_40[] = {
	{ 0,	5,	"sf240" },
	{ 1,	5,	"sf480" },
	{ 2,	5,	"sf960" },
	{ 3,	6,	"sf1920" },
...
static const unsigned int asn_MAP_mac_ContentionResolutionTimer_r15_enum2value_40[] = {
	7,	/* sf10240(7) */
	3,	/* sf1920(3) */
	0,	/* sf240(0) */
	4,	/* sf3840(4) */
...
static const asn_INTEGER_specifics_t asn_SPC_mac_ContentionResolutionTimer_r15_specs_40 = {
	asn_MAP_mac_ContentionResolutionTimer_r15_value2enum_40,	/* "tag" => N; sorted by tag */
	asn_MAP_mac_ContentionResolutionTimer_r15_enum2value_40,	/* N => "tag"; sorted by N */
	8,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_mac_ContentionResolutionTimer_r15_tags_40[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_mac_ContentionResolutionTimer_r15_40 = {
	"mac-ContentionResolutionTimer-r15",
	"mac-ContentionResolutionTimer-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_mac_ContentionResolutionTimer_r15_tags_40,
	sizeof(asn_DEF_mac_ContentionResolutionTimer_r15_tags_40)
		/sizeof(asn_DEF_mac_ContentionResolutionTimer_r15_tags_40[0]) - 1, /* 1 */
	asn_DEF_mac_ContentionResolutionTimer_r15_tags_40,	/* Same as above */
	sizeof(asn_DEF_mac_ContentionResolutionTimer_r15_tags_40)
		/sizeof(asn_DEF_mac_ContentionResolutionTimer_r15_tags_40[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_mac_ContentionResolutionTimer_r15_constr_40,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mac_ContentionResolutionTimer_r15_specs_40	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_edt_Parameters_r15_28[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15, edt_LastPreamble_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_edt_LastPreamble_r15_constr_29,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_edt_LastPreamble_r15_constraint_28
		},
		0, 0, /* No default value */
		"edt-LastPreamble-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15, edt_SmallTBS_Enabled_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15, edt_TBS_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_edt_TBS_r15_31,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15, mac_ContentionResolutionTimer_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_mac_ContentionResolutionTimer_r15_40,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_edt_Parameters_r15_oms_28[] = { 3 };
static const ber_tlv_tag_t asn_DEF_edt_Parameters_r15_tags_28[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_edt_Parameters_r15_tag2el_28[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_edt_Parameters_r15_specs_28 = {
	sizeof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15),
	offsetof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15, _asn_ctx),
	asn_MAP_edt_Parameters_r15_tag2el_28,
	4,	/* Count of tags in the map */
	asn_MAP_edt_Parameters_r15_oms_28,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_edt_Parameters_r15_28 = {
	"edt-Parameters-r15",
	"edt-Parameters-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_edt_Parameters_r15_tags_28,
	sizeof(asn_DEF_edt_Parameters_r15_tags_28)
		/sizeof(asn_DEF_edt_Parameters_r15_tags_28[0]) - 1, /* 1 */
	asn_DEF_edt_Parameters_r15_tags_28,	/* Same as above */
	sizeof(asn_DEF_edt_Parameters_r15_tags_28)
		/sizeof(asn_DEF_edt_Parameters_r15_tags_28[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_edt_Parameters_r15_28,
	4,	/* Elements count */
	&asn_SPC_edt_Parameters_r15_specs_28	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_27[] = {
	{ ATF_POINTER, 1, offsetof(struct RACH_CE_LevelInfo_r13__ext1, edt_Parameters_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_edt_Parameters_r15_28,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext1_oms_27[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ext1_tags_27[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_27[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* edt-Parameters-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_27 = {
	sizeof(struct RACH_CE_LevelInfo_r13__ext1),
	offsetof(struct RACH_CE_LevelInfo_r13__ext1, _asn_ctx),
	asn_MAP_ext1_tag2el_27,
	1,	/* Count of tags in the map */
	asn_MAP_ext1_oms_27,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ext1_27 = {
	"ext1",
	"ext1",
	&asn_OP_SEQUENCE,
	asn_DEF_ext1_tags_27,
	sizeof(asn_DEF_ext1_tags_27)
		/sizeof(asn_DEF_ext1_tags_27[0]) - 1, /* 1 */
	asn_DEF_ext1_tags_27,	/* Same as above */
	sizeof(asn_DEF_ext1_tags_27)
		/sizeof(asn_DEF_ext1_tags_27[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	asn_MBR_ext1_27,
	1,	/* Elements count */
	&asn_SPC_ext1_specs_27	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RACH_CE_LevelInfo_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_CE_LevelInfo_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_27,
		0,

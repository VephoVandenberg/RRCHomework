...
typedef enum LogMeasReport_r10__ext1__logMeasAvailableBT_r15 {
	LogMeasReport_r10__ext1__logMeasAvailableBT_r15_true	= 0
} e_LogMeasReport_r10__ext1__logMeasAvailableBT_r15;
typedef enum LogMeasReport_r10__ext1__logMeasAvailableWLAN_r15 {
	LogMeasReport_r10__ext1__logMeasAvailableWLAN_r15_true	= 0
} e_LogMeasReport_r10__ext1__logMeasAvailableWLAN_r15;
...
typedef struct LogMeasReport_r10 {
	 ...
	 */
	struct LogMeasReport_r10__ext1 {
...
extern asn_TYPE_member_t asn_MBR_LogMeasReport_r10_1[7];
